...
@Component({
  ...
  template: `
    <h3 class="page-title">All Listings</h3>
    <p class="page-subtitle">Full live status trail across every listing on the platform.</p>
        ...
        <table class="w-full text-sm">
          ...
          <tbody>
            @for (l of rows(); track l.id) {
              ...
              <tr><td colspan="5"><app-empty-state icon="fa-solid fa-inbox" text="No listings match this filter" /></td></tr>
            }
          </tbody>
        </table>
      </div>
