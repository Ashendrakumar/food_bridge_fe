...
@Component({
  ...
  template: `
    <h3 class="page-title">Dispute Resolution</h3>
    <p class="page-subtitle">Investigate and resolve issues raised on deliveries.</p>
    ...
    <div class="grid gap-3 lg:grid-cols-2 mb-6">
      @for (d of open(); track d.id) {
        ...
        <div class="lg:col-span-2"><app-empty-state icon="fa-solid fa-circle-check" text="No open disputes — all clear" /></div>
      }
    </div>
